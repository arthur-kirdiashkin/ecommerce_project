...
const String locationPath = 'assets/location.svg';
final Widget locationIcon = SvgPicture.asset(locationPath);

const String filterPath = 'assets/filter.svg';
final Widget filterIcon = SvgPicture.asset(filterPath);

const String geoPositionPath = 'assets/geo_position.svg';
final Widget geoPositionIcon = SvgPicture.asset(geoPositionPath);

const String booksPath = 'assets/select_category_icons/books.svg';
final Widget booksIcon = SvgPicture.asset(booksPath);

const String computerPath = 'assets/select_category_icons/computer.svg';
final Widget computerIcon = SvgPicture.asset(computerPath);

const String healthPath = 'assets/select_category_icons/health.svg';
final Widget healthIcon = SvgPicture.asset(healthPath);

const String phonesPath = 'assets/select_category_icons/phones.svg';
final Widget phonesIcon = SvgPicture.asset(phonesPath);

const String searchPath = 'assets/search.svg';
...
const String cartPlusPath = 'assets/cart_plus.svg';
final Widget cartPlusIcon = SvgPicture.asset(cartPlusPath);

const String cartMinusPath = 'assets/cart_minus.svg';
final Widget cartMinusIcon = SvgPicture.asset(cartMinusPath);

const String cartBasketPath = 'assets/cart_basket.svg';
final Widget cartBasketIcon = SvgPicture.asset(cartBasketPath);
